...
import static intreprisemanagementsystem.journal.comptem;
...
ResultSet rs= null;
                           ...
                           
     {
        ...
        SimpleDateFormat dateFormats = new SimpleDateFormat("yyyy-MM-dd");
         ...
         String date2 = dateFormats.format(jDateChooser2.getDate());
           ...
           String tmp =journal1.buss.getText();
          // this.setAlwaysOnTop (false);
            ...
            String NameFile=""+NameFiles+"journaldecaise.jrxml";
              ...
              String sql="Select * from ohada_trans INNER JOIN projet ON ohada_trans.BUSS=projet.PROJET_NUM where buss='"+tmp+" ' and DATES BETWEEN '"+date1+"' AND '"+date2+"'AND CODE ='"+journal1.code1.getText()+"'  order by DATES,ohada_trans.NUM";
 ...
 MessageFormat header = new MessageFormat("Projet: "+journal1.buss.getText()+"  "+journal1.code1.getText()+": "+journal1.compte1.getText());   
 MessageFormat footer = new MessageFormat("Page{0,number,integer}"); 
 try{
home_Table.jTable2.print(JTable.PrintMode.FIT_WIDTH,header,footer);
...
this.dispose();
 String  PRINCIPAL=null;
      ...
      //  JOptionPane.showMessageDialog(null, PRINCIPAL);  zima hotel
           
             if( PRINCIPAL=="Yes" || !journal.classe1.getText().equals("5")){
report(); 
}else{
report_CDF();
}
