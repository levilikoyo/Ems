 ...
 * @author DOSHE
 */
public class store_dispact extends javax.swing.JFrame {
...
bg2.add(pas_access);
     ...
     public void call_table1(){
           try{
             ...
             String sql="SELECT NOM FROM  stock_bin_location WHERE CAT='depot'";
...
//         
        if(jTextField1.getText().isEmpty()){
          try {
    PreparedStatement pst = con.prepareStatement("INSERT INTO  caisse_dispacting(NAME,CAT,ACCESS,CAT1,STATUT)"
        +"value(?,?,?,?,?)");  
         pst.setString(1, name.getText());
         pst.setString(2, cat.getText());
         pst.setString(3, choix);
         pst.setString(4, "depot");
  ...
  // JOptionPane.showMessageDialog(null,"Data Saved");
    ...
    PreparedStatement pst = con.prepareStatement("UPDATE  `caisse_dispacting` SET`ACCESS`=?,STATUT=? WHERE NAME='"+name.getText()+"' AND CAT='"+cat.getText()+"'");
  ...
  // JOptionPane.showMessageDialog(null,"Data Saved");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Store Allocation");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sub Store", "Main Store" }));
...
call_table2();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(store_dispact.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new store_dispact().setVisible(true);
            }
        });
    }
