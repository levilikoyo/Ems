 ...
 * @author Dosh
 */
public class home_buss_select extends javax.swing.JFrame {

   Connection con=null;
PreparedStatement pst=null;
ResultSet rs= null;
 DefaultTableModel mode;
    public home_buss_select() {
        initComponents();
  ...
  public void tableselected(){
       ...
       try{
          ...
          try{
            ...
            String sqls="select SUM(DEBIT),SUM(CREDIT),(SUM(DEBIT)-SUM(CREDIT)) from BUDGET_TRANS  WHERE PROJET='"+journal1.buss.getText()+"'";// AND SUBSTR=57 AND LB='' and journal1='OK'";
...
this.dispose();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(home_buss_select.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new home_buss_select().setVisible(true);
            }
        });
    }
