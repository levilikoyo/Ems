 ...
 * @author Dosh
 */
public class home_compte extends javax.swing.JFrame {
...
ResultSet rs= null;
 DefaultTableModel mode;
   ...
   public void attLIST_from_EMPLOYEView_used()
    {
         try{
            String sql="select * from  ohada WHERE SUBSTR='"+journal1.ohada.getText()+"'";
    ...
    public void search_code()
    {
       ...
       String sqls="SELECT  CODE as 'Numéro',`NAME` AS 'Intitulé du compte' FROM `ohada` where code like'"+code.getText()+"%' and SUBSTR='"+journal1.ohada.getText()+"' ";
       pst = con.prepareStatement(sqls);
      rs= pst.executeQuery();
     ...
     public void search_name()
    {
       ...
       String sqls="SELECT  CODE as 'Numéro',`NAME` AS 'Intitulé du compte' FROM `ohada` where name like'"+name.getText()+"%' and SUBSTR='"+journal1.ohada.getText()+"' ";
       pst = con.prepareStatement(sqls);
      rs= pst.executeQuery();
 ...
 public void tableselectedcompte(){
            int row= home_compte.etjTable3.getSelectedRow();
         // String rows =jTable1.getName()
          String Table_click = (home_compte.etjTable3.getModel().getValueAt(row,0). toString());   
        ...
        //`NAME`, `CODE`, `COMPTEMERE`, `CODEMERE`, `CLASS`, `SUBSTR`
            String sm= rs.getString("code");
             journal1.code2.setText(sm);
            
            String sm1=rs.getString("NAME");
            journal1.compte2.setText(sm1);
            String sm2=rs.getString("COMPTEMERE");
            journal1.comptemere2.setText(sm2);
            String sm3=rs.getString("CODEMERE");
           journal1.code_m2.setText(sm3);
            String sm4=rs.getString("CLASS");
            journal1.classe2.setText(sm4);
            String sm5=rs.getString("SUBSTR");
           journal1.substr2.setText(sm5);
          }
...
search_name();        // TODO add your handling code here:
...
name.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(home_compte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new home_compte().setVisible(true);
            }
        });
    }
