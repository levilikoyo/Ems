 ...
 * @author Dosh
 */
public class docs extends javax.swing.JPanel {
...
public void Table()
    {
         try{
             ...
             String sql="SELECT DOC,POINT FROM DOCSS where status='Offre' and offre='"+home_offre.batch.getSelectedValue()+"'";
...
public void etdelete()
    {
       ...
       String num=numS.replace("'", "''");
         try{
        String sql = "DELETE FROM DOCSS WHERE doc='"+num+"' and status='Offre' and offre='"+home_offre.batch.getSelectedValue()+"'";
...
try{
 con=JavaDbConnect.dbConnect(); 
 if (home_offre.batch.getSelectedValue().equals("")){
      JOptionPane.showMessageDialog(null,"Wrong Data"+"\n"+"  veuillez sélectionner l'offre","Error",JOptionPane.WARNING_MESSAGE);
