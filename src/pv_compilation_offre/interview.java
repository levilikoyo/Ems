...
public void Table()
    {
         try{
             ...
             String sql="SELECT DOC,POINT FROM DOCSS where status='Interview' and offre='"+home_offre.batch.getSelectedValue()+"'";
...
public void etdelete()
    ...
    String num=numS.replace("'", "''");
         try{
        String sql = "DELETE FROM DOCSS WHERE doc='"+num+"' and status='Interview'";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Question Interview");
