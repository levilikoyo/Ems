 ...
 * @author Dosh
 */
public class lettre_out extends javax.swing.JPanel {
...
int x,y;
   ...
   public void rolls(){
        ...
        // String sql="SELECT NUM FROM lettre where status='Letter Out'   ORDER BY NUM DESC LIMIT 1";
          String sql="SELECT NUM FROM lettre where SUBSTR(NUM,11,8)='"+addDateS+"' AND status='Letter Out'  ORDER BY NUM DESC LIMIT 1";
    ...
    public void roll()
     {
         ...
         int SUBSTRING = 0,UPSTRING = 0,SUPUPSTRING = 0;
          try{
          String sql="SELECT * FROM  transaction_number WHERE PROJET='LETTER' and NAME='LETTER-OUT'";
...
public void Table()
    {
         try{
             ...
             String sql="SELECT exp,Objet FROM lettre where STATUS='Letter Out'";
...
public void etdelete()
    {
         try{
        String sql = "DELETE FROM lettre WHERE num='"+num.getText()+"' and status='Letter out'";
...
String imgPath=null; 
  public void broswer()
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Courrier Sortant");
...
if(dest.getText().equals("")||dates.getText().equals("")||emet.getText().equals("")||objet.getText().equals("")||paths.getText().equals("")||cat.getSelectedItem().equals("Select On Cat")){
