 ...
 * @author DOSHE
 */
public class Pharma_registrer extends javax.swing.JFrame {
...
public void login(){
    ...
    try {
    PreparedStatement pst = con.prepareStatement("INSERT INTO `Pharma_User`(`NAME`, `USER`, `CAT`)"
        +"value(?,?,?)");  
  ...
  // JOptionPane.showMessageDialog(null,"Data Saved");
   ...
   user.setText("");
    ...
    private void initComponents() {
        ...
        dep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pharmacie", "User2" }));
...
login();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pharma_registrer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
