 ...
 * @author DOSHE
 */
public class user_dispact extends javax.swing.JFrame {
     ...
     public void call_table2(){
        ...
        name.setText(Table_click1);
           try{
             ...
             String sql="SELECT distinct(CAT) FROM `user_write_big` WHERE NAME='"+name.getText()+"'";
     //  String sql="SELECT ID, `NUM_FACTURE`, `DATE_FACTURE`, `DESCRIPTION`, `DEBIT_QTY`, `DEBIT_PU`, `DEBIT_PT`, `DEBIT_TVA`, `CREDIT_QTY`, `CREDIT_PU`, `CREDIT_PT`, `CREDIT_TVA`, `DATES`, `NUM` FROM facture_fournisseur where compte='"+jComboBox6.getSelectedItem()+"'";
       pst = con.prepareStatement(sql);
      rs= pst.executeQuery();
...
public void login(){
  ...
  // JOptionPane.showMessageDialog(null,"Data Saved");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("User Dispacting");
...
jTextField1.setText("");
        ...
        try{
            ...
            String sql="SELECT  ACCESS FROM  user_write_big  WHERE  NAME='"+name.getText()+"' and CAT='"+cat.getText()+"'";
...
cat.setText(Table_click1);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(user_dispact.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new user_dispact().setVisible(true);
            }
        });
    }
