    ...
    public transaction_number() {
     ...
     public void call_table1(){
          ...
          JOptionPane.showMessageDialog(null, ex); } 
           try{
             ...
             String sql="SELECT NAME,NUM,SUBSTR FROM `transaction_number`";
     ...
     public void call_table(){
            ...
            try{
             ...
             String sql="SELECT  `NAME`, `NUM`, `SUBSTR` FROM `transaction_number` WHERE NAME='"+jComboBox1.getSelectedItem()+"' AND PROJET='"+buss.getSelectedItem()+"' ";// WHERE NAME='"+jComboBox1.getSelectedItem()"' AND PROJET='"+buss.getSelectedItem()+"'";
     //  String sql="SELECT ID, `NUM_FACTURE`, `DATE_FACTURE`, `DESCRIPTION`, `DEBIT_QTY`, `DEBIT_PU`, `DEBIT_PT`, `DEBIT_TVA`, `CREDIT_QTY`, `CREDIT_PU`, `CREDIT_PT`, `CREDIT_TVA`, `DATES`, `NUM` FROM facture_fournisseur where compte='"+jComboBox6.getSelectedItem()+"'";
       pst = con.prepareStatement(sql);
      rs= pst.executeQuery();
...
public void save(){
     ...
     try{
         ...
         if(rs.next()){
         try {
    PreparedStatement pst = con.prepareStatement("UPDATE `transaction_number` SET `NUM`='"+num.getText()+"',`SUBSTR`='"+substring.getText()+"' WHERE NAME='"+jComboBox1.getSelectedItem()+"' AND PROJET='"+buss.getSelectedItem()+"'");
...
//         
 ...
 call_table();           
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EB", "BSC-USD", "BSC-CDF", "BSB-USD", "BSB-CDF", "BEC-USD", "BEC-CDF", "BEB-USD", "BEB-CDF", "ARCHIVE" }));
        ...
        substring.setBorder(javax.swing.BorderFactory.createEtchedBorder());
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(num, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
