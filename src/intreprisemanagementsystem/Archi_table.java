 ...
 * @author Dosh
 */
public class Archi_table extends javax.swing.JPanel {
    Connection con=null;
...
public void calltable(){
       try{
            // `COMPTE_M`, `COMPTE`, `CODE_M`, `CODE`, `CLASSE`, `SUBSTR`, `DEBIT`, `CREDIT`, `NUM`, `DATES`, `BUSS`, `LIBELLE`, `JOURNAL`, `CODE1`, `NUM_FACTURE`, `DEBIT_CDF`, `CREDIT_CDF`    
             String tmp=home_Achive.buss.getSelectedItem().toString();
...
public void showEBDataON(){ 
    int row= jTable1.getSelectedRow();
          String Table_clicks = (jTable1.getModel().getValueAt(row,2). toString());
           String Table_click = (jTable1.getModel().getValueAt(row,0). toString());
          home_Achive.objet.setText(Table_clicks);
           home_Achive.ref.setText(Table_click);
...
showEBDataON();        // TODO add your handling jrn here:
