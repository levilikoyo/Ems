 ...
 * @author Dosh
 */
public class caisse_dates_brouillon extends javax.swing.JFrame {

   Connection con=null;
PreparedStatement pst=null;
ResultSet rs= null;
 DefaultTableModel mode;
    public caisse_dates_brouillon() {
        initComponents();
        ...
        SimpleDateFormat dateFormats = new SimpleDateFormat("yyyy-MM-dd");
         ...
         String date2 = dateFormats.format(jDateChooser2.getDate());
          ...
          // this.setAlwaysOnTop (false);
            ...
            String NameFile=""+NameFiles+"caisse_brouillon.jrxml";
              ...
              String sql="select * from caisse_bruoilon where buss='"+tmp+" ' and DATE BETWEEN '"+date1+"' AND '"+date2+"'AND CAISSE ='"+caisse_bruoillons.jComboBox1.getSelectedItem()+"'  order by DATE,NUM";
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(caisse_dates_brouillon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new caisse_dates_brouillon().setVisible(true);
            }
        });
    }
