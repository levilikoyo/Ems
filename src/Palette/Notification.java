...
public class Notification extends javax.swing.JComponent {
    ...
    private void init(String message) {
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Palette/sucess.png")));
            lbMessage.setText("Success");
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Palette/info.png")));
            lbMessage.setText("Info");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Palette/warning.png")));
    ...
    private void initComponents() {
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon("C:\\Users\\Doshe PC\\Desktop\\swing-notification-main\\src\\javaswingdev\\close.png")); // NOI18N
