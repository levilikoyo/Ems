...
public class Search_Item extends javax.swing.JPanel {
    ...
    private void setData(DataSearch data) {
        ...
        if (data.isStory()) {
            ...
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Palette/time.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Palette/search.png"))); // NOI18N
